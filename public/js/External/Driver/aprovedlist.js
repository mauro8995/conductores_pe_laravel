    ...
    "columns":[
...

      {
         ...
         "render": function ( data, type, full, meta ) {
           return '<a  onclick="getDataProceso('+full.id_office+', '+full.id+')"><i class="glyphicon glyphicon-th-list"></i><a>';
          }
      },
      {data:"documentos",
        "render": function ( data, type, full, meta) {
      ...
      }},
      {
         sortable: false,
         "render": function ( data, type, full, meta ) {
           return '<a onclick="updatedriverid('+full.id_off+')"><i class="glyphicon glyphicon-user"></i><a>';
          }
      },
      {data:"estatusapi",
        "render": function ( data, type, full, meta) {
...
function updatedriverid(id_office){
  $("#modal-cargando").modal('show');
   $.ajax({
     url: "/actualizaraplicacionconductor/"+id_office,
     type:"GET",
     beforeSend: function () {
     },
   }).done( function(d) {
