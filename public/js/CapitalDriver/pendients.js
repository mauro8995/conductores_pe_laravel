$(document).ready(function(){
  ...
  $('#recargas tbody').on('click','#changeStatus',           function () {
     ...
     alertify.confirm('ESTAS REALIZANDO UN CAMBIO DE ESTATUS - RECARGA CONDUCTOR', '   ¿Está usted seguro que desea realizar esta operación?', function(){
...
$.fn.updateStatus       = function(id, status, table){
  ...
  $.ajax({
           ...
           success:  function (response) {
              alertify.alert('Gestion de Estatus', response, function(){
                $.fn.getData();
              });
             }
  });
