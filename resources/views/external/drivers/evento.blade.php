  ...
  <div class="row">
    <div class="col-xs-12 col-md-12">
      {{-- DATOS PERSONALES --}}
        <div class="box box-primary">
          ...
          <div class="box-body">
            <form  id=formPersonal>
              ...
              <div  class="col-md-12 col-md-6 padd2">
                ...
                <div class="col-xs-12 col-sm-9 col-md-8 padd">
                    ...
                    <button type="button" name="button" class="btn btn-default"  onclick="data_id()">buscar</button>
                </div>
             </div>
            ...
            <div  class="col-md-12 col-md-6 padd2">
              ...
              <div class="col-xs-12 col-sm-9 col-md-8 padd">
                  ...
                  <button type="button" name="button" class="btn btn-default"  onclick="data_dni()">buscar</button>
              </div>
           </div>
           <div  class="col-md-12 col-md-6 padd2">
         ...
         <div  class="col-md-12 col-md-6 padd2">
           ...
           <div class="col-xs-12 col-sm-9 col-md-8 padd">
               ...
               <button type="button" name="button" class="btn btn-default"  onclick="data_email()">buscar</button>
           </div>
        </div>
        ...
        <div  class="col-md-12 col-md-6 padd2">
          ...
          <div class="col-xs-12 col-sm-9 col-md-8 padd">
              ...
              <button type="button" name="button" class="btn btn-default"  onclick="data_phone()">buscar</button>
          </div>
       </div>
      ...
      <div  class="col-md-12 col-md-6 padd2">
        ...
        <div class="col-xs-12 col-sm-9 col-md-8 padd">
            <button type="button" name="button" class="btn btn-default" onclick="update()">guardar</button>
        </div>
     </div>
