        ...
        <form action="#" id="myform" method="POST">
          ...
          <div class="form-group">
               <div class="row">
                 ...
                 <div class="col-sm-6"><label for="Datos">AÑO CARRO:<code>*</code></label>
                   <div class="input-group">
                     <div class="input-group-addon">
                       <i class="fa  fa-map-marker"></i>
                     </div>
         ...
         <div class="form-group">
          ...
          <div class="form-group">
           ...
           <div class="form-group">
               <div class="row">
                   <div class="col-sm-6"><label for="Datos">Fecha de Emisión:</label>
                     <div class="input-group">
                       <div class="input-group-addon">
                         <i class="fa  fa-map-marker"></i>
                       </div>
          ...
          <div class="form-group" id="divafocat">
              <div class="row">
                  <div class="col-sm-6"><label for="Datos">Compañia:</label>
                    <div class="input-group">
                      <div class="input-group-addon">
                        <i class="fa  fa-map-marker"></i>
                      </div>
