...
@section('title', 'ACTUALIZAR SPONSOR DE CONDUCTOR')
@section('css')
<!-- JavaScript -->
...
<section class="content">
  <div class="box" style="padding: 35px;">
    <div class="box-header">
      <h3>ACTUALIZAR SPONSOR DE CONDUCTOR</h3>
    ...
    <meta name="csrf-token" content="{{ csrf_token() }}">
      <div class="seccion">
        <div class="form-group">
          <div class="row">
            <div class="col-xs-12 col-md-6"><label for="Datos">USUARIO: <code>*</code></label>
        ...
        <div class="form-group">
            ...
            <div class="col-xs-12 col-md-6"><label for="Datos">Nombres:</label>
              <div class="input-group">
                ...
                <input type="text" class="form-control" id="first_name_inv" name="first_name_inv">
              </div>
            </div>
            <div class="col-xs-12 col-md-6"><label for="Datos">Apellidos:</label>
              <div class="input-group">
                ...
                <input type="text" class="form-control" id="last_name_inv" name="last_name_inv">
              </div>
            </div>
          </div>
        </div>
...
@endsection
@section('js')
<script src="{{ asset('js/External/Driver/sponsorview.js')}} "></script>
@endsection
