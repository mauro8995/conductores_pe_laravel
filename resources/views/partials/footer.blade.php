      ...
      <div class="row">
        ...
        <div class="col-sm-4 padding-footer"><!-- Contact -->
          <div class="row">
            ...
            <a href="https://goo.gl/maps/ss2zu5Gxiitaz1ae9" class="col-xs-12 link-footer">Dirección de oficina principal:<br>Jirón Pataz 1253, urbanización COVIDA II Etapa, Los Olivos, Lima, Lima, Perú. </a>
            <br>
