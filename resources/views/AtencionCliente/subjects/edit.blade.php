...
<section class="content-header">
   ...
   <div class="content">
       <div class="box box-primary">
           <div class="box-body">
               <div class="row">
                   {!! Form::model($subjects, ['route' => ['subjects.update', 'id' => $subjects->id], 'method' => 'POST']) !!}
                      ...
                      <div class="form-group col-sm-6">
                          ...
                          {!! Form::select('id_groups_tickets', $groupsTicket, null, ['id'=>'id_groups_tickets','placeholder'=>'Selecciona' ,'class'=>'form-control select2', 'style'=>'width: 100%'] ) !!}
                      </div>
